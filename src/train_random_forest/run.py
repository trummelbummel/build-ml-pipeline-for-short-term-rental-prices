...
def go(args):
    ...
    ######################################
    # store trainval artifact in train local path.
    ...
    model_artifact = wandb.Artifact(args.output_artifact, "model_export",
                                    description="Exported model pipeline.", metadata=rf_config)
